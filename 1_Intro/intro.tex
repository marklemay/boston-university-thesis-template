...
This document is set to ``sloppy'' so long unbreakable words should be fine:
...
You can keep your \LaTeX sources in git.
If you use Github, a draft copy of your pdf can automatically be generated and shared (see the .gitub directorey).
This document lives at \url{https://github.com/marklemay/boston-university-thesis-template}.
% and was generated with \gitHash{} at \gitBranch{}. % if anyone can ever figure out \usepackage{gitinfo2} 
